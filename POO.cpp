...
void main()
{
	...
	Cladire* pc2 = pc; 
	cout << "Adresa cladirii pc2 ---Ia adresa cladirii pc si o pune in cladirea pc2. Cladire *pc2=pc= " << pc2->adresa << endl;
	Cladire* pc3 = &c; // obtine adresa lui c si o pune in pc
	cout << "Obtine adresa lui &c si o pune in *pc3  == " << pc3->adresa<< "= adresa c = " << c.adresa<< endl;
